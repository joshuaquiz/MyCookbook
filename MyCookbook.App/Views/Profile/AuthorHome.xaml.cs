...
public partial class AuthorHome
{
    ...
    private async Task LoadProfileAsync()
    {
        try
        {
            ...
            System.Diagnostics.Debug.WriteLine($"PreviewName: {ViewModel.PreviewName}, PreviewImageUrl: {ViewModel.PreviewImageUrl}");

            // Pre-populate with preview data if available (this sets the UI immediately)
            ViewModel.PrePopulateFromPreviewData();

            System.Diagnostics.Debug.WriteLine($"After PrePopulate - Author: {ViewModel.Author?.Name}");
    ...
    protected override async void OnAppearing()
    {
        ...
        catch (ObjectDisposedException)
        {
            ...
            System.Diagnostics.Debug.WriteLine("OnAppearing: Page disposed");
        }
        catch (Exception ex)
        {
            // Log but don't crash
    ...
    protected override void OnDisappearing()
    {
        ...
        System.Diagnostics.Debug.WriteLine("OnDisappearing - Reset _hasLoadedProfile flag");
    }
